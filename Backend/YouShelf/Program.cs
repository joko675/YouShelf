    ...
    using (var connection = new SqliteConnection(connectionString))
{
    ...
    sql.ExecuteNonQuery();
    sql.CommandText = @"CREATE TABLE IF NOT EXISTS BOOKS (BookId INTEGER PRIMARY KEY AUTOINCREMENT, Title TEXT NOT NULL, Author TEXT, Description TEXT, ReleaseDate TEXT, ImageUrl TEXT NOT NULL, Review TEXT, Status TEXT NOT NULL, UserId INTEGER NOT NULL);";
    sql.ExecuteNonQuery();
